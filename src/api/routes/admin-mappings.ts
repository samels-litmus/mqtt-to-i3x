...
export async function registerAdminMappingsRoutes(
  ...
  fastify.post<{ Body: CreateMappingBody }>(
    '/admin/mappings',
    async (request, reply) => {
      const engine = request.apiContext.mappingEngine;
  ...
  fastify.put<{ Params: MappingParams; Body: UpdateMappingBody }>(
    '/admin/mappings/:id',
    async (request, reply) => {
      const engine = request.apiContext.mappingEngine;
      const { id } = request.params;
  ...
  fastify.delete<{ Params: MappingParams }>(
    '/admin/mappings/:id',
    async (request, reply) => {
      const engine = request.apiContext.mappingEngine;
      const { id } = request.params;
